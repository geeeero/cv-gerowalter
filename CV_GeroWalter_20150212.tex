...
%Teaching: see \url{http://www.statistik.lmu.de/~walter/lehre_en.html}. ***oder auflisten?***
...
\item[\hspace*{-2ex}\bfseries 2007 -- 2013] Research Assistant at the Working Group `Methodological Foundations of Statistics and their Applications'
                    ...
                    Responsibilities included teaching for statistics and other majors, %postgraduate ???
...
%\bibliography{../../doktorarbeit/bibfile/eigene_110609}
\renewcommand\refname{List of publications}
\label{publications}
\bibliography{eigene_140915}
%
%\begin{picture}
%\put(0,0){ABC}
%\end{picture
