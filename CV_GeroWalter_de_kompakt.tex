...
\label{awards}
%\begin{itemize}
\rule{2ex}{0ex}$\bullet$ Best poster award (1st Prize) bei der \href{http://www.sipta.org/isipta15/?pag=presentation}{ISIPTA'15} (mit F.~Coolen und S.D.~Flapper)\\[0.7ex]
\rule{2ex}{0ex}$\bullet$ Best poster award (2nd Prize) bei der \href{http://www.sipta.org/isipta15/?pag=presentation}{ISIPTA'15} (mit C.~Jansen und T.~Augustin)\\[0.7ex]
\rule{2ex}{0ex}$\bullet$ \href{http://www.sipta.org/isipta11/index.php?id=prizes_ijar}{IJAR Young Researcher Award 2011} (Silver Award)\\[0.7ex]
\rule{2ex}{0ex}$\bullet$ Best poster award (1st Prize) bei der \href{http://www.geeeero.de/files/talk-2011b-ISIPTA-sna-bestposter-small.jpg}{ISIPTA'11} (mit M.~Eugster und T.~Augustin)
%\end{itemize}
%\begin{topic}
...
SPSS, SAS, GNU/Linux, \texttt{git} \\[0.7ex]
